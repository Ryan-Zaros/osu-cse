...
public abstract class ListTest {
    ...
    /**
     * Tests retreat when the left list has one element and the right is empty.
     */
    @Test
    ...
    /**
     * Tests retreat when both the left and right lists have one element.
     */
    @Test
    ...
    /**
     * Tests retreat when the left list has one element and the right list has
    ...
    /**
     * Tests retreat when the left list has more than one element and the right
     * is empty.
     */
    @Test
