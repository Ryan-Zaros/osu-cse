...
public final class NaturalNumberRoot {
    ...
    public static void root(NaturalNumber n, int r) {
        ...
        // Loop until difference is zero
        while (difference.compareTo(one) > 0) {
            // Start at the average of the two bounds
            guess.copyFrom(tooHigh);
            guess.add(lowEnough);
            guess.divide(two);

            // Take the root of the guess
            power.copyFrom(guess);
            power.power(r);

            // Set new guess depending on distances from bounds
        ...
        // Change n to closest integer root
